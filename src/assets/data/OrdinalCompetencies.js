    ...
    competencies: [
      {
        ...
        def: "Ability to adhere / adjust to policies, processes, procedures and rules",
        statements: [
      ...
      {
        competency_name: "Empathy",
        def: "Ability to understand and respect others' perspectives and emotions",
        statements: [
          "Sensitive to the signs of overwork in team / others",
          "Takes an active interest in the concerns expressed by others",
        ],
      },
      {
        ...
        statements: [
          ...
          "Seeks improvement in organizational processes and contributes to its successful implementation",
        ],
      },
      {
        ...
        statements: [
          ...
          "Understands and considers long-term and underlying issues affecting the organization",
        ],
      },
    ],
  },
    ...
    competencies: [
      {
        ...
        statements: [
          ...
          "Promotes creative / out of box approach in the function she/he leads",
        ],
      },
      {
      ...
      },
      {
        ...
        statements: [
          ...
          "Identifies and mitigates bias on a personal, departmental, organizational and process level ",
        ],
      },
      {
        ...
        statements: [
          ...
          "Maintains transparency in decisions and actions",
        ],
      },
    ],
  },
    ...
    competencies: [
      {
        ...
        statements: [
          ...
          "Holds credible rapport with stakeholders",
        ],
      },
      {
        ...
        statements: [
          ...
          "Forms alliances with key players to get things done",
        ],
      },
      {
      ...
      },
      {
        ...
        statements: [
          ...
          "Conveys persuasive messages to gain support whilst being able to defend viewpoint appropriately",
        ],
      },
    ],
  },
    ...
    competencies: [
      {
        ...
        statements: [
          ...
          "Strives to exceed expectations by improving operations, performance and outcomes",
        ],
      },
      {
        ...
        statements: [
          ...
          "Provides direction. Builds capacity for the organization to deliver results, face challenges and develop continually",
        ],
      },
      {
        ...
        statements: [
          ...
          "Uses good judgement to aid / make quality decisions ",
        ],
      },
      {
    ...
    competencies: [
      {
        ...
        statements: [
          ...
          "Empowers team members to develop their skills and competencies",
        ],
      },
      {
        ...
        statements: [
          ...
          "Integrates executive / corporate directives into key tasks and decisions",
        ],
      },
      {
        ...
        statements: [
          ...
          "Translates vision into clear strategies ",
        ],
      },
      {
        ...
        statements: [
          ...
          "Addresses business challenges responsibly ",
        ],
      },
    ],
  },
    ...
    competencies: [
      {
        ...
        statements: [
          ...
          "Takes initiatives on regular basis at team / departmental level",
        ],
      },
      {
        ...
        statements: [
          ...
          "Ensures effective risk controls",
        ],
      },
      {
        ...
        statements: [
          ...
          "outcome RESULTS IN INCREASED VALUE ADDITION ",
        ],
      },
      {
        ...
        statements: [
          ...
          "Reporting team members have a low attrition rate ",
        ],
      },
    ],
  },
